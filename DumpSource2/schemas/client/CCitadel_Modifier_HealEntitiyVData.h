...
//	"_class": "CCitadel_Modifier_HealEntitiyVData",
...
class CCitadel_Modifier_HealEntitiyVData : public CCitadelModifierVData
{
	...
	// MPropertyDescription = "How much max health to heal from 0 to 1 as (0 to 100%)"
	float32 m_flMaxHealthHeal;
	float32 m_flFlatHeal;
};
