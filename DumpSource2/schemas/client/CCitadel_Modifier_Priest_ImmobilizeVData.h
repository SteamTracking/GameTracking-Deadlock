...
//	"_class": "CCitadel_Modifier_Priest_ImmobilizeVData",
//	"m_flDuration": -1.000000,
//	"m_bKeepMaximumDurationOnRefresh": false,
//	"m_strParticleEffect": "particles/modifiers/root.vpcf",
...
class CCitadel_Modifier_Priest_ImmobilizeVData : public CCitadel_Modifier_RootVData
{
	// MPropertyStartGroup = "Gameplay"
	float32 flMaxDrag;
	float32 flSpeedForNoDrag;
	float32 flSpeedForMaxDrag;
};
