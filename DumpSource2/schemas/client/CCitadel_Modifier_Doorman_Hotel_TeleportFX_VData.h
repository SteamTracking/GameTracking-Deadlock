...
//	"_class": "CCitadel_Modifier_Doorman_Hotel_TeleportFX_VData",
...
class CCitadel_Modifier_Doorman_Hotel_TeleportFX_VData : public CCitadelModifierVData
{
	...
	CSoundEventName m_strKeyLoopSound;
	CSoundEventName m_strKeyLoopStartSound;
	CSoundEventName m_strKeyLoopEndSound;
