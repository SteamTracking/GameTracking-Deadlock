...
//	"_class": "CCitadel_Modifier_InvisVData",
...
class CCitadel_Modifier_InvisVData : public CCitadelModifierVData
{
	...
	bool m_bFadeToVisibleAtEndOfDuration;
	float32 m_flMinCloak;
	float32 m_flMaxCloak;
};
