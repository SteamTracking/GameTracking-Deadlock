...
//	"_class": "CModifierPsychicLiftVData",
...
//	"m_flRiseTime": 0.500000,
//	"m_flSlamTime": 0.250000,
//	"m_flRiseAcc": 100.000000,
//	"m_flRiseMaxSpeed": 100.000000,
//	"m_flRiseDecayFracStart": 0.500000,
//	"m_flRiseDecayFracEnd": 0.900000,
//	"m_flSlamAcc": 500.000000,
...
class CModifierPsychicLiftVData : public CCitadel_Modifier_StunnedVData
{
	...
	float32 m_flOccilateMaxDistance;
	float32 m_flOccilateDegreesPerSecond;
	float32 m_flRiseTime;
	// MPropertyDescription = "Once this duration has pased in the slam, we start forcing the target to the ground"
	float32 m_flSlamTime;
	float32 m_flRiseAcc;
	float32 m_flRiseMaxSpeed;
	float32 m_flRiseDecayFracStart;
	float32 m_flRiseDecayFracEnd;
	float32 m_flSlamAcc;
	float32 m_flSlamMaxSpeed;
	float32 m_flSlamImpactRadius;
};
