...
//	"_class": "CCitadelModifierDruidInvisVData",
...
class CCitadelModifierDruidInvisVData : public CCitadelModifierVData
{
	// MPropertyStartGroup = "Visuals"
	float32 m_flHideDuration;
	float32 m_flRevealDuration;
};
