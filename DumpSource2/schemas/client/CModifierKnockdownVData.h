...
//	"_class": "CModifierKnockdownVData",
...
//	"m_flSatVolumeRadius": 500.000000,
//	"m_flSatVolumeFadeOut": 200.000000,
//	"m_flGravityScale": 2.000000,
//	"m_flDesatAmount": 1.000000,
//	"m_satColorDesat":
//	[
//		150,
//		207,
...
class CModifierKnockdownVData : public CCitadel_Modifier_StunnedVData
{
	...
	float32 m_flSatVolumeFadeOut;
	float32 m_flGravityScale;
	float32 m_flDesatAmount;
	Color m_satColorDesat;
	Color m_satColorSat;
	Color m_satColorOutline;
	// MPropertyStartGroup = "Camera"
	float32 m_flGetUpSeqDuration;
	CitadelCameraOperationsSequence_t m_cameraSequenceGetUp;
};
