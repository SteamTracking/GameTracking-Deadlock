...
//	"_class": "CCitadel_Modifier_PunkgoatPullVData",
...
//	"m_PullForceFracByDistanceCurve":
//	{
//		"m_spline":
//		[
//		],
...
class CCitadel_Modifier_PunkgoatPullVData : public CCitadelModifierVData
{
	...
	CPiecewiseCurve m_PullForceFracByDistanceCurve;
	float32 m_flPullToCasterLocationDuration;
};
