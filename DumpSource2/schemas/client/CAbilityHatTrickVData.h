...
class CAbilityHatTrickVData : public CitadelAbilityVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_HatTrickChannelParticle;
