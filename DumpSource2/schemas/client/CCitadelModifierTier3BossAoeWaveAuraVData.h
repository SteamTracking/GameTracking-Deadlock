...
//	"_class": "CCitadelModifierTier3BossAoeWaveAuraVData",
...
class CCitadelModifierTier3BossAoeWaveAuraVData : public CCitadelModifierAuraVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_AmberWaveParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SapphWaveParticle;
};
