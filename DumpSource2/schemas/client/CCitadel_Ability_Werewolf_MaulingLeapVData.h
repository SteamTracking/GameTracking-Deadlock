...
//	"_class": "CCitadel_Ability_Werewolf_MaulingLeapVData",
...
class CCitadel_Ability_Werewolf_MaulingLeapVData : public CitadelAbilityVData
{
	...
	float32 m_flVelocityCarryoverOnHit;
	...
	CGlobalSymbol m_strAG2SuccessHeroState;
};
