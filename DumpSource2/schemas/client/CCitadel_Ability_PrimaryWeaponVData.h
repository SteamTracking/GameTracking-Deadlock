...
//	"_class": "CCitadel_Ability_PrimaryWeaponVData",
...
class CCitadel_Ability_PrimaryWeaponVData : public CitadelAbilityVData
{
	...
	float32 m_flActionReloadTimingStart;
	// MPropertyDescription = "If we have action reloads, how long is the window"
	float32 m_flActionReloadTimingDuration;
	...
	CustomCrosshairSettings_t m_CustomCrosshairSettings;
	...
	CUtlString m_strPassiveWeaponAttachmentSource;
};
