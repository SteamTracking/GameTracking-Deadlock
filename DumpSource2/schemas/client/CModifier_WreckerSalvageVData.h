...
//	"_class": "CModifier_WreckerSalvageVData",
...
class CModifier_WreckerSalvageVData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SalvageBeam;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_ConnectBeam;
};
