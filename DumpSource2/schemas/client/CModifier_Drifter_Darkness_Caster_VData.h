...
//	"_class": "CModifier_Drifter_Darkness_Caster_VData",
...
class CModifier_Drifter_Darkness_Caster_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SpiritBulletImpactParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SpiritBulletTracerParticle;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_strSpiritBulletHitSound;
};
