...
//	"_class": "CCitadel_Modifier_PatronsBlessingProcWatcherVData",
...
//	}
//}
class CCitadel_Modifier_PatronsBlessingProcWatcherVData : public CCitadel_Modifier_BaseEventProcVData
{
	// MPropertyGroupName = "Modifiers"
	CEmbeddedSubclass< CCitadelModifier > m_DamageTracker;
};
