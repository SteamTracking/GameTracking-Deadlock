...
//	"_class": "CCitadel_Modifier_SilencedVData",
...
//	"m_EmpParticle": "particles/modifiers/silenced_debuff.vpcf",
...
class CCitadel_Modifier_SilencedVData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_EmpParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_EmpPlayerParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_EmpStatusParticle;
};
