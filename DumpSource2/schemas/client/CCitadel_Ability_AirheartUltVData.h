...
//	"_class": "CCitadel_Ability_AirheartUltVData",
...
//	"m_FlareParticle": "",
//	"m_TeleportParticle": "",
//	"m_PackageOpenParticle": "",
//	"m_PackagePunchedParticle": "",
//	"m_PackageCrashedOnGroundParticle": "",
//	"m_PackageModel": "",
//	"m_flModelScale": 1.000000,
//	"m_flGravitySlowFalling": 0.000000,
//	"m_flGravityFalling": 0.000000,
//	"m_flMaxElevation": 0.000000,
...
class CCitadel_Ability_AirheartUltVData : public CitadelAbilityVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_FlareParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_TeleportParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_PackageOpenParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_PackagePunchedParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_PackageCrashedOnGroundParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeCModel > > m_PackageModel;
	float32 m_flModelScale;
	// MPropertyStartGroup = "Package"
	float32 m_flGravitySlowFalling;
	float32 m_flGravityFalling;
	float32 m_flMaxElevation;
	float32 m_flSlowFallElevationStart;
	float32 m_flSlowFallElevationEnd;
};
