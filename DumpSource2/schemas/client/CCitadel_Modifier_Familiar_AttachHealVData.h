...
//	"_class": "CCitadel_Modifier_Familiar_AttachHealVData",
...
class CCitadel_Modifier_Familiar_AttachHealVData : public CCitadelModifierVData
{
	// MPropertyStartGroup = "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_HealBurstParticle;
};
