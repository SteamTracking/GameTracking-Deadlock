...
//	"_class": "CAbility_Fathom_ReefdwellerHarpoon_VData",
...
class CAbility_Fathom_ReefdwellerHarpoon_VData : public CitadelAbilityVData
{
	...
	float32 m_flAirDrag;
	float32 m_flInitialSlowSpeed;
	float32 m_flInitialSpeedBias;
	float32 m_flMaxSurfacePitch;
};
