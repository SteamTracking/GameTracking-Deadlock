...
//	"_class": "CCitadel_Modifier_MutedVData",
...
//	"m_MutedParticle": "particles/modifiers/muted_debuff.vpcf",
//	"m_MutedPlayerParticle": "particles/modifiers/muted_player_debuff.vpcf",
//	"m_MutedStatusParticle": "particles/status_fx/status_fx_silenced.vpcf"
//}
// MHasKV3TransferPolymorphicClassname
class CCitadel_Modifier_MutedVData : public CCitadelModifierVData
{
	// MPropertyStartGroup = "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_MutedParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_MutedPlayerParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_MutedStatusParticle;
};
