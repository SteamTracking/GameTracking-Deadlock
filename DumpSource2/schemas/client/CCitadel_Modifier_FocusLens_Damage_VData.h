...
//	"_class": "CCitadel_Modifier_FocusLens_Damage_VData",
...
class CCitadel_Modifier_FocusLens_Damage_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_DamageTakenParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_FinalDamageParticle;
};
