...
//	"_class": "CCitadel_Ability_Necro_HauntingSpiritsVData",
...
class CCitadel_Ability_Necro_HauntingSpiritsVData : public CitadelAbilityVData
{
	// MPropertyGroupName = "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_BuffCastParticle;
