...
//	"_class": "CCitadel_Modifier_Necro_HauntingSpiritsVData",
...
class CCitadel_Modifier_Necro_HauntingSpiritsVData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_BlockParticle;
	// MPropertyGroupName = "Sound"
	CSoundEventName m_strTargetFoundSound;
};
