...
class CAbilityMeleeVData : public CitadelAbilityVData
{
	...
	float32 m_flMeleeInputBufferTime;
	...
	float32 m_flLightAttackMaxHoldTime;
	...
	float32 m_flBackDashDodgeDist;
	TakeDamageFlags_t m_MeleeDamageFlags;
	CUtlString m_strEffectsAttachName;
	// MPropertyStartGroup = "AnimGraph2"
	float32 m_flChargeAnimDelayTime;
};
