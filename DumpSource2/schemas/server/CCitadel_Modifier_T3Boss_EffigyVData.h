...
//	"_class": "CCitadel_Modifier_T3Boss_EffigyVData",
...
class CCitadel_Modifier_T3Boss_EffigyVData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_AmberEffigyEffect;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SapphEffigyEffect;
};
