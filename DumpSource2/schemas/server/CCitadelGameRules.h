...
class CCitadelGameRules : public CTeamplayRules
{
	...
	CountdownTimer m_CheckCheatersTimer;
	GameTime_t m_flTimeScaleStart;
	GameTime_t m_flTimeScaleEndTime;
	GameTime_t m_flTimeScaleRampInEndTime;
	GameTime_t m_flTimeScaleRampOutStartTime;
	float32 m_flTimeScaleRampInTime;
	float32 m_flTimeScaleDuration;
	float32 m_flTimeScaleRampOutTime;
