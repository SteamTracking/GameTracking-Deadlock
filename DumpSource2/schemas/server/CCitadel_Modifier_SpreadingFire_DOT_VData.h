...
//	"_class": "CCitadel_Modifier_SpreadingFire_DOT_VData",
...
class CCitadel_Modifier_SpreadingFire_DOT_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_sSpreadingFireParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_sSpreadingFireTetherParticle;
};
