...
//	"_class": "CModifier_Drifter_Darkness_Target_BoundaryUnit_VData",
...
class CModifier_Drifter_Darkness_Target_BoundaryUnit_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_strBoundaryPuffParticle;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_strAuraEnterPlayerSound;
	CSoundEventName m_strAuraEnterNPCSound;
};
