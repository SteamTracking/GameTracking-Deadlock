...
//	"_class": "CCitadel_Modifier_Tokamak_HeatSinks_DOT_VData",
...
class CCitadel_Modifier_Tokamak_HeatSinks_DOT_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_sAfterburnParticle;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_sAfterburnExplodeParticle;
};
