...
//	"_class": "CCitadel_Modifier_Fervor_Bonuses_VData",
...
class CCitadel_Modifier_Fervor_Bonuses_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_BonusesParticle;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_ActivateBonusesSound;
};
