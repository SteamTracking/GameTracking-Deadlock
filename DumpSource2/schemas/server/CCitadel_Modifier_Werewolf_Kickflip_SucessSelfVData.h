...
//	"_class": "CCitadel_Modifier_Werewolf_Kickflip_SucessSelfVData",
...
class CCitadel_Modifier_Werewolf_Kickflip_SucessSelfVData : public CCitadelModifierVData
{
	...
	CPiecewiseCurve m_InitialVelocityCurve;
	CPiecewiseCurve m_KickOffVelocityCurve;
};
