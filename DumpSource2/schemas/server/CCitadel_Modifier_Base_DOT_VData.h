...
//	"_class": "CCitadel_Modifier_Base_DOT_VData",
...
class CCitadel_Modifier_Base_DOT_VData : public CCitadelModifierVData
{
	// MPropertyStartGroup = "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_sDOTParticle;
};
