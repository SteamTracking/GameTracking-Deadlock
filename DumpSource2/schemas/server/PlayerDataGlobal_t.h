...
class PlayerDataGlobal_t
{
	...
	CNetworkUtlVectorBase< int32 > m_vecBonusCounterValues;
	// MNetworkEnable
	CNetworkUtlVectorBase< CUtlStringToken > m_vecBonusCounterModifiers;
	// MNetworkEnable
	// MNetworkUserGroup = "Abilities"
	// MNetworkChangeCallback = "pdgBonusCounterChanged"
	CNetworkUtlVectorBase< int32 > m_vecModifierBonusCounterValues;
	// MNetworkEnable
	// MNetworkUserGroup = "Abilities"
	// MNetworkChangeCallback = "pdgUpgradesChanged"
	CUtlStringToken m_tHeldItem;
	// MNetworkEnable
	CUtlVectorEmbeddedNetworkVar< ItemImbuementPair_t > m_vecImbuements;
	// MNetworkEnable
	CUtlVectorEmbeddedNetworkVar< DynamicAbilityValues_t > m_vecDynamicAbilityValues;
	// MNetworkEnable
	CUtlVectorEmbeddedNetworkVar< StatViewerModifierValues_t > m_vecStatViewerModifierValues;
	// MNetworkEnable
	// MNetworkUserGroup = "Abilities"
	// MNetworkChangeCallback = "pdgStolenAbilityChanged"
	CUtlVectorEmbeddedNetworkVar< StolenAbilityPair_t > m_vecStolenAbilities;
	// MNetworkEnable
	// MNetworkUserGroup = "Abilities"
	// MNetworkChangeCallback = "pdgAbilityUpgradeStateChanged"
	CUtlVectorEmbeddedNetworkVar< AbilityUpgradeState_t > m_vecAbilityUpgradeState;
	// MNetworkEnable
