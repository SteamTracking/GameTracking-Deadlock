...
//	"_class": "CCitadel_Modifier_ElectricSlippersVData",
...
class CCitadel_Modifier_ElectricSlippersVData : public CCitadel_Modifier_Intrinsic_BaseVData
{
	// MPropertyStartGroup = "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_BuffParticle;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_strSlideLoopSound;
};
