...
//	"_class": "CCitadel_Modifier_Priest_CrossbowEquippedVData",
...
class CCitadel_Modifier_Priest_CrossbowEquippedVData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_WeaponBuffParticle;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_BlessedLoopSound;
	CSoundEventName m_AimLoopSound;
};
