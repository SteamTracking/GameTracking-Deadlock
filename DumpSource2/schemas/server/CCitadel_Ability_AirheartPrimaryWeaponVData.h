...
//	"_class": "CCitadel_Ability_AirheartPrimaryWeaponVData",
...
class CCitadel_Ability_AirheartPrimaryWeaponVData : public CCitadel_Ability_PrimaryWeaponVData
{
	...
	CEmbeddedSubclass< CCitadelModifier > m_StuckModifier;
	// MPropertyStartGroup = "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_ExplosionFX;
};
