...
//	"_class": "CCitadel_Modifier_Unicorn_DazzlingOrbNextTargetVData",
...
class CCitadel_Modifier_Unicorn_DazzlingOrbNextTargetVData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_NextTargetParticle;
};
