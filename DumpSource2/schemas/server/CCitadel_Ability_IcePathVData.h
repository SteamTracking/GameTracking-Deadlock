...
//	"_class": "CCitadel_Ability_IcePathVData",
...
//	{
//	},
//	"m_flMomentumDecayRate": 1.000000,
//	"m_flMomentumWeight": 0.800000,
//	"m_flMaxPitchChange": 5.000000,
//	"m_flMaxPitchUp": 15.000000,
//	"m_flMaxPitchDown": 15.000000,
...
class CCitadel_Ability_IcePathVData : public CitadelAbilityVData
{
	...
	float32 m_flMomentumDecayRate;
	float32 m_flMomentumWeight;
	float32 m_flMaxPitchChange;
	float32 m_flMaxPitchUp;
	float32 m_flMaxPitchDown;
	float32 m_flMaxHeight;
	float32 m_flForwardAngleBias;
};
