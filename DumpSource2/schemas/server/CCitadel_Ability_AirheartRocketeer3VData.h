...
//	"_class": "CCitadel_Ability_AirheartRocketeer3VData",
...
//	"m_flTargetingConeAngle": 0.000000,
//	"m_flTargetingConeHalfWidth": 10.000000,
...
//	"m_JetpackFireFX": "",
//	"m_VTOLExplosionFX": "",
//	"m_flAirDashDistancePct": 0.000000,
//	"m_flAirDrag": 0.000000,
//	"m_flAirSpeed": 0.000000,
//	"m_flBeginJetpackingVelocityMultiplier": 0.000000,
//	"m_flTimeToHoldBeforeBeginJetpack": 0.000000,
//	"m_flVerticalDampening_FallingBelowNeutral": 0.000000,
//	"m_flVerticalDampening_FallingAboveNeutral": 0.000000,
//	"m_flVerticalDampening_RisingBelowNeutral": 0.000000,
//	"m_flVerticalDampening_RisingAboveNeutral": 0.000000,
//	"m_flVerticalDeadzoneSoft": 0.000000,
//	"m_flVerticalDeadzoneHard": 0.000000,
//	"m_flPreservedVelocityDecaySpeed": 0.000000,
//	"m_flIntentMultiplierApproachSpeed": 0.000000,
//	"m_flMPCOriginCoeff": 0.000000,
//	"m_flMPCVelocityCoeff": 0.000000,
//	"m_flMPCScale": 0.000000,
//	"m_flMPCMaxAccel": 0.000000,
//	"m_flMoveSpaceSpeed_ZUp": 0.000000,
//	"m_flMoveSpaceSpeed_ZDown": 0.000000,
//	"m_flMoveSpaceSpeed_Lateral": 0.000000,
//	"m_flMoveSpaceSpeed_LateralZUp": 0.000000,
//	"m_flMoveSpaceSpeed_Forward": 0.000000,
//	"m_flMoveSpaceSpeed_Backward": 0.000000,
//	"m_flIntentSpaceSoftZone": 0.000000,
//	"m_flIntentSpaceHardZone": 0.000000,
//	"m_flHardZoneCoeffFrac": 0.000000,
//	"m_flSoftZoneCoeffFrac": 0.000000,
//	"m_OverdriveLateral":
//	{
//		"m_spline":
//		[
...
//		]
//	},
//	"m_flOverdriveCooldown": 0.000000,
//	"m_flConsumedBySideThrusting": 0.000000,
//	"m_flConsumedWhileActive": 0.000000,
//	"m_flHoverVelocityDecaySpeed": 0.000000,
//	"m_VTOLSpeedByTime":
//	{
//		"m_spline":
//		[
...
//		]
//	},
//	"m_flVTOLCamTurnRate": 0.000000,
//	"m_VTOLModifier":
//	{
//	},
//	"m_flMaxVTOLBounceSpeed": 0.000000,
//	"m_flVTOLFloorBounceZSpeed": 0.000000,
//	"m_flWallAttachCooldown": 0.000000,
//	"m_flWallJumpSpeed": 0.000000,
//	"m_flWallAttachMinDuration": 0.000000,
//	"m_strOutOfFuelSound": "",
//	"m_strOverdriveActivatedSound": "",
//	"m_strJetpackingLoop": "",
//	"m_strJetpackingThrustingLoop": "",
//	"m_cameraSequenceVTOL":
//	{
//		"m_strToken": "",
//		"m_bIsEmpty": false,
//		"m_nPriority": 1,
...
class CCitadel_Ability_AirheartRocketeer3VData : public CitadelAbilityVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_JetpackFireFX;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_VTOLExplosionFX;
	// MPropertyStartGroup = "Jetpack Movement"
	float32 m_flAirDashDistancePct;
	float32 m_flAirDrag;
	float32 m_flAirSpeed;
	float32 m_flBeginJetpackingVelocityMultiplier;
	float32 m_flTimeToHoldBeforeBeginJetpack;
	float32 m_flVerticalDampening_FallingBelowNeutral;
	float32 m_flVerticalDampening_FallingAboveNeutral;
	float32 m_flVerticalDampening_RisingBelowNeutral;
	float32 m_flVerticalDampening_RisingAboveNeutral;
	float32 m_flVerticalDeadzoneSoft;
	float32 m_flVerticalDeadzoneHard;
	float32 m_flPreservedVelocityDecaySpeed;
	float32 m_flIntentMultiplierApproachSpeed;
	// MPropertyStartGroup = "Jetpack Movement - MPC"
	float32 m_flMPCOriginCoeff;
	float32 m_flMPCVelocityCoeff;
	float32 m_flMPCScale;
	float32 m_flMPCMaxAccel;
	// MPropertyStartGroup = "Jetpack Movement - Movement Space Speeds"
	float32 m_flMoveSpaceSpeed_ZUp;
	float32 m_flMoveSpaceSpeed_ZDown;
	float32 m_flMoveSpaceSpeed_Lateral;
	float32 m_flMoveSpaceSpeed_LateralZUp;
	float32 m_flMoveSpaceSpeed_Forward;
	float32 m_flMoveSpaceSpeed_Backward;
	// MPropertyStartGroup = "Jetpack Movement - Intent Space Soft & Hard Zones"
	float32 m_flIntentSpaceSoftZone;
	float32 m_flIntentSpaceHardZone;
	float32 m_flHardZoneCoeffFrac;
	float32 m_flSoftZoneCoeffFrac;
	// MPropertyStartGroup = "Jetpack Movement - Impulse Overdrive"
	CPiecewiseCurve m_OverdriveLateral;
	float32 m_flOverdriveCooldown;
	// MPropertyStartGroup = "Jetpack Movement - Fuel"
	float32 m_flConsumedBySideThrusting;
	float32 m_flConsumedWhileActive;
	// MPropertyStartGroup = "Jetpack Movement - Hover"
	float32 m_flHoverVelocityDecaySpeed;
	// MPropertyStartGroup = "Jetpack Movement - VTOL"
	CPiecewiseCurve m_VTOLSpeedByTime;
	float32 m_flVTOLCamTurnRate;
	CEmbeddedSubclass< CCitadelModifier > m_VTOLModifier;
	float32 m_flMaxVTOLBounceSpeed;
	float32 m_flVTOLFloorBounceZSpeed;
	// MPropertyStartGroup = "Jetpack Movement - Wall Attach"
	float32 m_flWallAttachCooldown;
	float32 m_flWallJumpSpeed;
	float32 m_flWallAttachMinDuration;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_strOutOfFuelSound;
	CSoundEventName m_strOverdriveActivatedSound;
	CSoundEventName m_strJetpackingLoop;
	CSoundEventName m_strJetpackingThrustingLoop;
	// MPropertyStartGroup = "Camera"
	CitadelCameraOperationsSequence_t m_cameraSequenceVTOL;
	CitadelCameraOperationsSequence_t m_cameraSequenceHover;
	CitadelCameraOperationsSequence_t m_cameraSequenceWallAttach;
	float32 flScreenShake_VTOL_Amplitude;
	float32 flScreenShake_VTOL_Frequency;
};
