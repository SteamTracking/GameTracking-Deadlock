...
//	"_class": "CModifierTier3BossLaserBeamAuraVData",
...
class CModifierTier3BossLaserBeamAuraVData : public CCitadelModifierAuraVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_AmberGroundEffect;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SapphGroundEffect;
};
