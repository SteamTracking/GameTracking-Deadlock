...
//	"_class": "CCitadel_Modifier_TangoTether_TetherReceiverVData",
...
class CCitadel_Modifier_TangoTether_TetherReceiverVData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_strAttackBuffParticle;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_sBuffLoopingSound;
};
