...
//	"_class": "CCitadel_Modifier_Rutger_CheatDeath_Activated_VData",
...
class CCitadel_Modifier_Rutger_CheatDeath_Activated_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_ActivatedParticle;
};
