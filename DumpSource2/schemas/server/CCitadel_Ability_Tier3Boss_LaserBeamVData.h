...
//	"_class": "CCitadel_Ability_Tier3Boss_LaserBeamVData",
...
class CCitadel_Ability_Tier3Boss_LaserBeamVData : public CitadelAbilityVData
{
	// MPropertyStartGroup = "Modifiers"
	CEmbeddedSubclass< CCitadelModifier > m_BeamModifier;
};
