...
//	"_class": "CNPC_TrooperNeutralVData",
//	"m_sModelName": "",
//	"m_hFootstepSounds": "",
...
class CNPC_TrooperNeutralVData : public CAI_CitadelNPCVData
{
	...
	float32 m_flGoldReward;
	float32 m_flGoldRewardBonusPercentPerMinute;
	bool m_bCapSimultanousAttackers;
	float32 m_flShieldReactivateDelay;
	float32 m_flDyingDuration;
	...
	bool m_bHasAOEAttack;
	float32 m_flAOERadius;
	float32 m_flAOEDamage;
	float32 m_flAOEAttackCooldown;
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_AOEParticle;
	CEmbeddedSubclass< CCitadelModifier > m_AOEDebuffToApply;
	CSoundEventName m_AOEInitiateSound;
	CSoundEventName m_AOESound;
	float32 m_AOEDebuffDuration;
	// MPropertyStartGroup = "Body"
	CUtlVector< CUtlString > m_vecRandomBodyGroup;
	CUtlVector< CUtlString > m_vecRandomSkin;
	// MPropertyStartGroup = "Visuals"
	float32 m_flHullCapsuleRadius;
	float32 m_flHullCapsuleHeight;
	// MPropertyStartGroup = "Idles"
	bool m_bFaceEnemyWhileIdle;
	CSoundEventName m_IdleLoopSound;
	// MPropertyStartGroup = "Movement"
	MoveType_t m_MoveType;
	// MPropertyStartGroup = "WeakPoints"
	int32 m_iWeakPointCount;
	ENeutralWeakPointType m_iWeakPointType;
	float32 m_iWeakPointRespawnTime;
