...
//	"_class": "CCitadel_Modifier_ActiveDisarm_SpiritSteal_VData",
...
class CCitadel_Modifier_ActiveDisarm_SpiritSteal_VData : public CCitadelModifierVData
{
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SpiritStealParticle;
};
