...
//	"_class": "CCitadelPlayerBotNPCBrainVData",
//	"m_sModelName": "",
//	"m_hFootstepSounds": "",
...
//	},
//	"m_flJumpMaxRise": 300.000000,
//	"m_flAirJumpMin": 200.000000,
//	"m_flJumpMaxDrop": 1024.000000,
//	"m_flJumpMaxDist": 200.000000,
//	"m_flJumpMinDist": 50.000000,
//	"m_flClimbUpCostBase": 32.000000,
//	"m_flClimbUpCostScalar": 4.000000,
//	"m_flFaceTargetDistance": 1200.000000,
//	"m_flNavGoalTolerance": 64.000000,
//	"m_flVerticalAttachOffset": 16.000000,
//	"m_flStuckTime": 1.500000,
//	"m_flStuckTimeAir": 3.000000,
//	"m_flMajorStuckTime": 30.000000,
//	"m_unMajorStuckAttemptCount": 30,
//	"m_flStuckDistance": 32.000000,
//	"m_flMaxPathDistance": 1300.000000,
//	"m_flMinLanePathDistance": 250.000000,
//	"m_flEnemyDistanceForReload": 1200.000000,
//	"m_flReloadEnemyFarPct": 0.500000,
//	"m_flReloadEnemyLoSPct": 0.500000,
//	"m_flReloadEnemyLosTime": 0.500000,
//	"m_flMinShootTimeToReload": 0.750000,
//	"m_flDashDamageThreshold": 0.050000,
//	"m_flDashDamageTickDown": 0.200000,
//	"m_flMinDesiredDashDist": 200.000000,
//	"m_flMinAbilityAimTime": 0.500000,
...
class CCitadelPlayerBotNPCBrainVData : public CAI_CitadelNPCVData
{
	...
	float32 m_flAirJumpMin;
	float32 m_flJumpMaxDrop;
	float32 m_flJumpMaxDist;
	float32 m_flJumpMinDist;
	float32 m_flClimbUpCostBase;
	float32 m_flClimbUpCostScalar;
	float32 m_flFaceTargetDistance;
	float32 m_flNavGoalTolerance;
	float32 m_flVerticalAttachOffset;
	float32 m_flStuckTime;
	float32 m_flStuckTimeAir;
	float32 m_flMajorStuckTime;
	int32 m_unMajorStuckAttemptCount;
	float32 m_flStuckDistance;
	float32 m_flMaxPathDistance;
	float32 m_flMinLanePathDistance;
	float32 m_flEnemyDistanceForReload;
	float32 m_flReloadEnemyFarPct;
	float32 m_flReloadEnemyLoSPct;
	float32 m_flReloadEnemyLosTime;
	float32 m_flMinShootTimeToReload;
	float32 m_flDashDamageThreshold;
	float32 m_flDashDamageTickDown;
	float32 m_flMinDesiredDashDist;
	float32 m_flMinAbilityAimTime;
	float32 m_flDisengageFromEnemyToLaneDist;
	float32 m_flDefendBaseSearchRadius;
};
