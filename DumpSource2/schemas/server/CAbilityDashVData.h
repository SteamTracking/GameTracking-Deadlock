...
//		]
//	},
//	"m_flMaxAngDiff": 20.000000,
//	"m_flSlideCancelBlockerWindow": 0.200000,
//	"m_flSlideLockoutTime": 0.400000,
//	"m_flGroundDashAirbornDrag": 1.000000,
//	"m_flGroundDashAirbornSpeedClamp": 750.000000,
//	"m_strGroundDashSound": "",
//	"m_flAirDashEndVelocityScale": 0.200000,
//	"m_flAirDashAccPct": 0.000000,
//	"m_flDuringDrag": 1.000000,
//	"m_flAirSpeedForMaxDrag": 14.000000,
//	"m_flAirSpeedForMinDrag": 10.000000,
...
class CAbilityDashVData : public CitadelAbilityVData
{
	...
	CitadelCameraOperationsSequence_t m_cameraSequenceGroundDashActivate;
	CitadelCameraOperationsSequence_t m_cameraSequenceAirDashActivate;
	// MPropertyStartGroup = "Ground Dash Stuff"
	float32 m_flMaxAngDiff;
	float32 m_flSlideCancelBlockerWindow;
	float32 m_flSlideLockoutTime;
	float32 m_flGroundDashAirbornDrag;
	float32 m_flGroundDashAirbornSpeedClamp;
	CSoundEventName m_strGroundDashSound;
	// MPropertyStartGroup = "Air Dash Stuff"
	float32 m_flAirDashEndVelocityScale;
	float32 m_flAirDashAccPct;
	float32 m_flDuringDrag;
	float32 m_flAirSpeedForMaxDrag;
	float32 m_flAirSpeedForMinDrag;
