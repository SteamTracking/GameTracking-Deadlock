...
//	"_class": "CCitadel_Modifier_TargetPracticeEnemyVData",
...
class CCitadel_Modifier_TargetPracticeEnemyVData : public CCitadelModifierVData
{
	...
	CEmbeddedSubclass< CCitadelModifier > m_BuildupCompleteModifier;
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_HeadParticle;
	// MPropertyStartGroup = "Sounds"
	CSoundEventName m_strTargetHitSound;
	CSoundEventName m_strTargetHeadShotHitSound;
	CSoundEventName m_strTargetCompleteSound;
};
